...
with open(fullFileName, 'w', newline='') as PLC_file:
    ...
    print("Setpoint: " + str(sp))
    plc.write_by_name("MAIN.sSetpoint", str(sp), pyads.PLCTYPE_STRING)
    while ((monotonic() - t0) >= (testTime * 5)) and ((monotonic() - t0) < (testTime * 6)):
    ...
    print("Setpoint: " + str(sp))
    plc.write_by_name("MAIN.sSetpoint", str(sp), pyads.PLCTYPE_STRING)
    while ((monotonic() - t0) >= (testTime * 6)) and ((monotonic() - t0) < (testTime * 7)):
    ...
    print("Setpoint: " + str(sp))
    plc.write_by_name("MAIN.sSetpoint", str(sp), pyads.PLCTYPE_STRING)
    while ((monotonic() - t0) >= (testTime * 7)) and ((monotonic() - t0) < (testTime * 8)):
    ...
    print("Setpoint: " + str(sp))
    plc.write_by_name("MAIN.sSetpoint", str(sp), pyads.PLCTYPE_STRING)
    while ((monotonic() - t0) >= (testTime * 8)) and ((monotonic() - t0) < (testTime * 9)):
    ...
    print("Setpoint: " + str(sp))
    plc.write_by_name("MAIN.sSetpoint", str(sp), pyads.PLCTYPE_STRING)
    while ((monotonic() - t0) >= (testTime * 9)) and ((monotonic() - t0) < (testTime * 10)):
